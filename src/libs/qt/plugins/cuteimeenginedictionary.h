...
#ifndef CUTEIMEENGINEDICTIONARY_H
#define CUTEIMEENGINEDICTIONARY_H
...
class CUTEIME_EXPORT CuteimeEngineDictionary : public QObject
{
    Q_OBJECT
public:
    CuteimeEngineDictionary(QObject *parent = 0);
    ~CuteimeEngineDictionary();
...
#endif//CUTEIMEENGINEDICTIONARY_H
