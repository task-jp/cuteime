...
#ifndef CUTEIMEABSTRACTPLUGINOBJECT_H
#define CUTEIMEABSTRACTPLUGINOBJECT_H
...
class CuteimeSettingsWidget;
#endif

class CUTEIME_EXPORT CuteimeAbstractPluginObject : public QObject
{
    Q_OBJECT
...
public:
    ...
    CuteimeAbstractPluginObject(QObject *parent = 0);
    ~CuteimeAbstractPluginObject();
...
#ifndef CUTEIME_NO_GUI
    virtual CuteimeSettingsWidget *settings(const QString &hint, QWidget *parent = 0);
#endif
...
#endif//CUTEIMEABSTRACTPLUGINOBJECT_H
