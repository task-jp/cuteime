...
static void cuteime_im_context_focus_in(GtkIMContext *context)
{
    ...
    if (self->d->application_manager) {
        if (self->d->client_window) {
            cuteime_application_manager_set_window(self->d->application_manager, gdk_x11_drawable_get_xid(self->d->client_window));
            cuteime_application_manager_set_widget(self->d->application_manager, gdk_x11_drawable_get_xid(self->d->client_window));
        }
...
static void cuteime_im_context_set_client_window(GtkIMContext *context, GdkWindow *client_window)
{
    ...
    if (self->d->application_manager) {
        if (client_window) {
            cuteime_application_manager_set_window(self->d->application_manager, gdk_x11_drawable_get_xid(client_window));
            cuteime_application_manager_set_widget(self->d->application_manager, gdk_x11_drawable_get_xid(client_window));
        } else {
            cuteime_application_manager_set_window(self->d->application_manager, 0);
            cuteime_application_manager_set_widget(self->d->application_manager, 0);
        }
