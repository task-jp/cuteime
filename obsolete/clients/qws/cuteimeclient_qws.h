...
#ifndef CUTEIMECLIENTQWS_H
#define CUTEIMECLIENTQWS_H

#include <QWSInputMethod>

class CuteimeClientQWS : public QWSInputMethod
{
    Q_OBJECT
public:
    CuteimeClientQWS(QObject *parent = 0);
    ~CuteimeClientQWS();
