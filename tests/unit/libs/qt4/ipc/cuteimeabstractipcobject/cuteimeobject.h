...
#ifndef CUTEIMEOBJECT_H
#define CUTEIMEOBJECT_H
...
class AbstractIpcObject : public CuteimeAbstractIpcObject
{
    Q_OBJECT
...
public:
    ...
    AbstractIpcObject(QObject *parent, CuteimeAbstractIpcObject::Type type);
    ~AbstractIpcObject();
    virtual bool init();
